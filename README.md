![Kingactyl](https://cdn.discordapp.com/attachments/987734229469253674/1000790022263423116/Copy_of_citric_3.png)
...
We cannot force you to keep the "Powered by Kingactyl & Heliactyl" in the footer, but please consider keeping it. It helps getting more visibility to the project and so getting better. We won't do technical support for installations without the notice in the footer. We may DMCA the website in certain conditions.
...
Warning: You need Pterodactyl already set up on a domain for Kingactyl to work
...
8. Run `certbot certonly -d <Your Kingactyl Domain>` then do 1 and put your email
9. Run `nano /etc/nginx/sites-enabled/Kingactyl.conf`
...
From Heliactyl Base v11/v12 or Dashactyl v0.4 to Kingactyl v1:
...
- Change directory to your Kingactyl folder Using `cd` command, Example: `cd /var/www/Kingactyl` 
- To run Kingactyl, use `pm2 start index.js --name "Kingactyl"`
- To view logs, run `pm2 logs Kingactyl`

Making the dashboard runs on startup:
- Make sure your dashboard is running in the background with the help of [pm2](https://github.com/Unitech/pm2)
- You can check if Kingactyl is running in background with `pm2 list`
- Once you confirmed that Kingactyl is running in background, you can create a startup script by running `pm2 startup` and `pm2 save`
- Note: Supported init systems are `systemd`, `upstart`, `launchd`, `rc.d`
- To stop your Kingactyl instance from running in the background, use `pm2 unstartup`

To stop a currently running Kingactyl instance, use `pm2 stop Kingactyl`

# Legacy Deprecation Notice

Heliactyl Base v6, v7, v8, v9, v10, v11 is now deprecated as listed in our Discord and should not be used.
Please update to Heliactyl Base v12/v13.
If we are not on Heliactyl Base that is supported please join our discord.
